...
class DeckControllerTest {
    ...
    @Test
    void testShohCardsFromDeckWithoutCards() throws IOException {
        URL url = new URL("http://localhost:10001/deck");
        HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
        urlConnection.setRequestMethod("GET");
    ...
    void testConfigureDeck() throws IOException {
        ...
        printWriter.write("[\"845f0dc7-37d0-426e-994e-43fc3ac83c08\", \"99f8f8dc-e25e-4a95-aa2c-782823f36e2a\", \"e85e3976-7c86-4d06-9a80-641c2019a79f\", \"1cb6ab86-bdb2-47e5-b6e4-68c5ab389334\"]");
        printWriter.close();
